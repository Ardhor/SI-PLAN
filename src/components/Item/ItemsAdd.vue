...
import { getSupplier, itemsAdd } from '../../lip/api/ItemsApi.js';
...
async function handlerItemsAdd() {
    const response = await itemsAdd(token.value, {
    ...
    if(response.status === 200){
        await alertSuccess("Add item Successfully")
    } else {
...
<template>
    ...
    <div
        ...
        <div class="p-8">
            <form v-on:submit.prevent="handlerItemsAdd">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="kategori" v-model="items.supplierId"
                                class="w-full pl-10 pr-3 py-3 bg-zinc-700 bg-opacity-50 border border-zinc-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200" required>
