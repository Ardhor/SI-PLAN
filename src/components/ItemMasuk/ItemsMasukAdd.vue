...
import { itemMasukAdd } from '../../lip/api/ItemMasukApi.js';
...
async function handlerItemMasukAdd() {
    ...
    if(response.status === 200){
        await alertSuccess("Add item masuk Successfully")
    } else {
...
console.log("price: ", itemMasuk.price)
</script>
...
<template>
    ...
    <div
        ...
        <div class="p-8">
            <form v-on:submit.prevent="handlerItemMasukAdd">
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-plus-circle mr-2"></i> Tambah Item Masuk
                    </button>
                </div>
            </form>
        </div>
